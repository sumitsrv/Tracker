...
//void GLG::mergeLevels(CvHistogram* hist_glg, float *max_value, int *hist_size, float left[], float right[])
//{
...
//void GLG::lookUpTable(float *N, float left[], float right[], int* hist_size, float T[])
//{
//    int i, j, curr_bin=0;
